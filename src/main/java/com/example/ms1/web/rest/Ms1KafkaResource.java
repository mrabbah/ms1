...
@RestController
@RequestMapping("/api/ms1-kafka")
public class Ms1KafkaResource {

    private final Logger log = LoggerFactory.getLogger(Ms1KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Ms1KafkaResource(KafkaProperties kafkaProperties) {
