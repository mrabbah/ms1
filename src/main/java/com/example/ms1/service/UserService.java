...
import com.example.ms1.repository.AuthorityRepository;
...
public class UserService {
    ...
    private User syncUserWithIdP(Map<String, Object> details, User user) {
        // save authorities in to sync user roles/groups between IdP and MS1's local database
        ...
        // save account in to sync users between IdP and MS1's local database
